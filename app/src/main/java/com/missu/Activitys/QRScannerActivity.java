...
import com.missu.R;
import com.missu.sll.qrdemo.camera.CameraManager;
import com.missu.sll.qrdemo.decoding.CaptureActivityHandler;
import com.missu.sll.qrdemo.decoding.InactivityTimer;
import com.missu.sll.qrdemo.view.ViewfinderView;
...
public class QRScannerActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    public void handleDecode(Result result) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            ...
            Intent intent = new Intent(QRScannerActivity.this,SearchResultActivity.class);
            intent.putExtra("account",resultString);
